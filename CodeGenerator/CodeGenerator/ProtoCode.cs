...
"
                ...
                {
                    cw.Bracket("namespace " + m.Namespace);
                    codeGen.GenerateClass(m, cw);
                    cw.EndBracket();
                }
            }
...
"
                ...
                {
                    cw.Bracket("namespace " + m.Namespace);
                    SerializerCode.GenerateClassSerializer(m, cw);
                    cw.EndBracket();
                }
...
namespace ProtocolBuffers
{
    ...
    {"
                ...
                foreach (Message m in proto.Messages)
                    SerializerCode.GenerateGenericClassSerializer(m, cw);
