    ...
    public static global::Google.Protobuf.MessageOptions Deserialize(Stream stream, global::Google.Protobuf.MessageOptions instance)
    {
        ...
        while (true)
        {
            ...
            switch (keyByte)
            {
                // Field 1 Varint
                case 8:
                    instance.MessageSetWireFormat = ReadBool(stream);
                    continue;
                // Field 2 Varint
                case 16:
                    instance.NoStandardDescriptorAccessor = ReadBool(stream);
                    continue;
            }
    ...
    public static void Serialize(Stream stream, MessageOptions instance)
    {
        using (var msField = new MemoryStream())
        {
            if (instance.MessageSetWireFormat != false)
            {
                ...
                stream.WriteByte(8);
                WriteBool(stream, instance.MessageSetWireFormat);
            }
            if (instance.NoStandardDescriptorAccessor != false)
            {
                // Key for field: 2, Varint
                stream.WriteByte(16);
                WriteBool(stream, instance.NoStandardDescriptorAccessor);
            }
            if (instance.UninterpretedOption != null)
            {
