...
public partial class MyMessage
{
    ...
    public static global::Proto.Test.MyMessage Deserialize(Stream stream, global::Proto.Test.MyMessage instance)
    {
        while (true)
        {
            ...
            switch (keyByte)
            {
                // Field 1 Varint
                case 8:
                    instance.Foo = (int)ReadUInt64(stream);
                    continue;
                // Field 2 LengthDelimited
                case 18:
                    instance.Bar = ReadString(stream);
                    continue;
            }
    ...
    public static void Serialize(Stream stream, MyMessage instance)
    {
        using (var msField = new MemoryStream())
        {
            ...
            stream.WriteByte(8);
            WriteUInt64(stream,(ulong)instance.Foo);
            if (instance.Bar != null)
            {
                // Key for field: 2, LengthDelimited
                stream.WriteByte(18);
                WriteBytes(stream, Encoding.UTF8.GetBytes(instance.Bar));
            }
        }
    }
